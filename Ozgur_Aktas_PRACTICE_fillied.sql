...
select * from personel_1 order by yas asc;
-- 18) personel bilgilerini maaşa göre sıralayınız.
select * from personel_1 order by maas asc;
...
union
select * from personel_1 where yas<35;
...
alter table personel_1 add sehir varchar(25), add meslek varchar(25);
--26) Personel_1 tablosuna sehir ve meslek sütunlarını ekleyiniz.
alter table personel_1 rename column sehir to sehir_adi;
