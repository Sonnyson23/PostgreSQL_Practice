...
-- 1.10 Her bir ürünün üreticisine ilişkin tüm veriler dahil olmak üzere, 
-- ürünlerdeki tüm verileri seçin.
SELECT *
FROM products
...
select products.name, products.price,manufacturers.name from products inner join manufacturers ON products.code= manufacturers.code;
